...
def main():
    ...
    model.fit(
        ...
        output_path="checkpoints/bge_small_finetuned",
        show_progress_bar=True,
    )
    print("Fine-tuned encoder saved to checkpoints/bge_small_finetuned")
    print("Next steps (manual): point src/preprocessing.py's encoder at this checkpoint,")
    print("re-run preprocessing + training, then re-run benchmark.py and compare")
    print("negation_flipped / confidently_wrong / paraphrase MAE before vs. after.")
